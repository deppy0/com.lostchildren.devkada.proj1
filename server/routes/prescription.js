...
router.post('/add', auth, async function(req, res) {
	try {
		...
		const { doctor_name, doc_specialization, date_issued, document_url, meds_list } = req.body;
		...
		const prescription_id = await prescription_service.addPrescription(user_id, doctor_name, doc_specialization, date_issued, document_url, meds_list);
